...
func gatewayHandlerChannelCreate(client bot.Client, sequenceNumber uint64, shardID int, event gateway.EventChannelCreate) {
...
func gatewayHandlerChannelUpdate(client bot.Client, sequenceNumber uint64, shardID int, event gateway.EventChannelUpdate) {
...
func gatewayHandlerChannelDelete(client bot.Client, sequenceNumber uint64, shardID int, event gateway.EventChannelDelete) {
...
func gatewayHandlerChannelPinsUpdate(client bot.Client, sequenceNumber uint64, shardID int, event gateway.EventChannelPinsUpdate) {
