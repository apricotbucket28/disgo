...
func (e *ComponentEvent) UpdateInteractionResponseString(content string, opts ...rest.RequestOpt) (*discord.Message, error) {
	return e.Client().Rest().UpdateInteractionResponse(e.ApplicationID(), e.Token(), discord.MessageUpdate{Content: &content}, opts...)
}
...
func (e *ComponentEvent) CreateFollowupMessageString(content string, opts ...rest.RequestOpt) (*discord.Message, error) {
...
func (e *ComponentEvent) UpdateFollowupMessageString(messageID snowflake.ID, content string, opts ...rest.RequestOpt) (*discord.Message, error) {
