...
func (e *ModalEvent) UpdateInteractionResponseString(content string, opts ...rest.RequestOpt) (*discord.Message, error) {
...
func (e *ModalEvent) CreateFollowupMessageString(content string, opts ...rest.RequestOpt) (*discord.Message, error) {
...
func (e *ModalEvent) UpdateFollowupMessageString(messageID snowflake.ID, content string, opts ...rest.RequestOpt) (*discord.Message, error) {
	messageUpdate := discord.MessageUpdate{Content: &content}
	return e.Client().Rest().UpdateFollowupMessage(e.ApplicationID(), e.Token(), messageID, messageUpdate, opts...)
}
